"""Parity check for sims/otyugh_cr5_x2 against its Phase 0 baseline. Same
column-renaming approach as check_otyugh_cr5_dps_parity.py — see that file's
docstring — plus the two otyugh instances (otyugh_1/otyugh_2 here, otyugh_a/
otyugh_b in the baseline).
"""
...
def main() -> int:
    sim_dir = Path(__file__).parent.parent / "sims" / "otyugh_cr5_x2"
    ...
    console = Console()
    table = Table(title=f"otyugh_cr5_x2 parity vs baseline: {'PASS' if report.passed else 'FAIL'}")
